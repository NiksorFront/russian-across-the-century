        ...
        <div class="container mx-auto py-6 sm:py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
                <a href="https://al-cg.com/" target="_blank" class="my-0 sm:my-1"> 
                    <img :src="allianceLegal" alt="Alliance Legal" class="hidden lg:block w-[54%] mx-auto object-contain invert" />
                </a>
                <div class="flex m-4 gap-1 max-w-[250px] justify-between">
            ...
            <!-- Контакты -->
            <div class="mx-4 my-0 sm:row-start-2 lg:row-start-1 lg:col-start-2 space-y-2">
            ...
            <!-- Контакты 2-->
            <div class="mx-4 my-0 sm:row-start-3 lg:row-start-1 lg:col-start-3 space-y-2">
            ...
            <div class="mx-4 space-y-2">
                ...
                <a href="https://al-cg.com/" target="_blank" class="block helvetica-500 footer__text hover:opacity-75 cursor-pointer transition-all">Юридическая защита</a>
            </div>
